(function() {
  ...
  CodeMirror3.showHint = function(cm, getHints, options) {
    ...
    CodeMirror3.signal(cm, "startCompletion", cm);
  ...
  Completion.prototype = {
    ...
    showWidget: function(data) {
      ...
      function done() {
        ...
        if (data) CodeMirror3.signal(data, "close");
      }

      function update() {
        if (finished) return;
        CodeMirror3.signal(data, "update");
        if (completion.options.async)
  ...
  function Widget(completion, data) {
    ...
    hints.className = "CodeMirror3-hints";
    this.selectedHint = 0;

    var completions = data.list;
    for (var i = 0; i < completions.length; ++i) {
      var elt = hints.appendChild(document.createElement("li")), cur = completions[i];
      var className = "CodeMirror3-hint" + (i ? "" : " CodeMirror3-hint-active");
    ...
    CodeMirror3.signal(data, "select", completions[0], hints.firstChild);
    return true;
  }
  ...
  Widget.prototype = {
    ...
    changeActive: function(i, avoidWrap) {
      ...
      node.className = node.className.replace(" CodeMirror3-hint-active", "");
      node = this.hints.childNodes[this.selectedHint = i];
      node.className += " CodeMirror3-hint-active";
