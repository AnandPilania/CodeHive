(function() {
  ...
  var HOVER_CLASS = " CodeMirror3-hover";

  function showTooltip(e, content) {
    var tt = document.createElement("div");
    tt.className = "CodeMirror3-hover-tooltip";
    ...
    function position(e) {
      if (!tt.parentNode)
        return CodeMirror3.off(document, "mousemove", position);
  ...
  function showTooltipFor(e, content, node, state, cm) {
    ...
    function hide() {
      ...
      CodeMirror3.off(node, "click", hide);
    ...
    CodeMirror3.on(node, "click", hide);
  ...
  function parseOptions(cm, options) {
    ...
    if (!options.getTextHover)
      options.getTextHover = cm.getHelper(CodeMirror3.Pos(0, 0), "textHover");
    if (!options.getTextHover)
      throw new Error(
  ...
  function optionHandler(cm, val, old) {
    if (old && old != CodeMirror3.Init) {
      CodeMirror3.off(cm.getWrapperElement(), "mouseover",
  ...
  CodeMirror3.defineOption("textHover", false, optionHandler); // deprecated
