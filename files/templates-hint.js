(function() {
  ...
  CodeMirror3.templatesHint.getCompletions = function(cm, completions, text) {
  ...
  CodeMirror3.templatesHint.addTemplates = function(templates) {
