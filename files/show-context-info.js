(function() {
  ...
  CodeMirror3.attachContextInfo = function(data) {
    CodeMirror3.on(data, 'select', function(completion, hints) {      
    ...
    CodeMirror3.on(data, 'close', function() {
      if (contextInfo != null) {
  ...
  CodeMirror3.showContextInfo = function(getHints) {
    return function(cm, showHints, options) {
      if (!options)
        options = showHints;
      var data = getHints(cm, options);
      CodeMirror3.attachContextInfo(data);
      return data;
    }
  }
